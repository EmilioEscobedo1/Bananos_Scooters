...
class VehiculosController extends AppController
{
    ...
    {
        $vehiculo = $this->Vehiculos->get($id, contain: ['Modelos', 'Estacions', 'Viajes']);
    ...
    public function add()
    {
        ...
        $estacions = $this->Vehiculos->Estacions->find('list', limit: 200)->all();
        $this->set(compact('vehiculo', 'modelos', 'estacions'));
    }
