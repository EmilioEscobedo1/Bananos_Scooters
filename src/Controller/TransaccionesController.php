...
class TransaccionesController extends AppController
{
    ...
    public function index()
    {
        $query = $this->Transacciones->find()
            ->contain(['Users', 'Viajes', 'MetodoDePagos', 'Promocions']);
    ...
    {
        $transaccione = $this->Transacciones->get($id, contain: ['Users', 'Viajes', 'MetodoDePagos', 'Promocions']);
    ...
    public function add()
    {
        ...
        $users = $this->Transacciones->Users->find('list', limit: 200)->all();
        $viajes = $this->Transacciones->Viajes->find('list', limit: 200)->all();
        $metodoDePagos = $this->Transacciones->MetodoDePagos->find('list', limit: 200)->all();
        $promocions = $this->Transacciones->Promocions->find('list', limit: 200)->all();
        $this->set(compact('transaccione', 'users', 'viajes', 'metodoDePagos', 'promocions'));
    }
