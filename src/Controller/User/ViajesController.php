...
class ViajesController extends AppController
{
    ...
    public function index()
    {
        $query = $this->Viajes->find()
            ->contain(['Users', 'Vehiculos', 'EstacionDestinos']);
    ...
    {
        $viaje = $this->Viajes->get($id, contain: ['Users', 'Vehiculos', 'EstacionDestinos', 'Transacciones']);
    ...
    public function add()
    {
        ...
        $estacionDestinos = $this->Viajes->EstacionDestinos->find('list', limit: 200)->all();
        $this->set(compact('viaje', 'users', 'vehiculos', 'estacionDestinos'));
    }
